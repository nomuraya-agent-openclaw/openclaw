...
export function renderApp(state: AppViewState) {
  ...
  const chatDisabledReason = state.connected ? null : t("connection.disconnected");
      ...
      <header class="topbar">
        <div class="topbar-left">
          <button
            ...
            title="${state.settings.navCollapsed ? t("ui.expandSidebar") : t("ui.collapseSidebar")}"
            aria-label="${state.settings.navCollapsed ? t("ui.expandSidebar") : t("ui.collapseSidebar")}"
          >
          ...
          <div class="brand">
            ...
            <div class="brand-text">
              ...
              <div class="brand-sub">${t("ui.gatewayDashboard")}</div>
            </div>
          </div>
        </div>
        <div class="topbar-status">
          <div class="pill">
            ...
            <span>${t("ui.health")}</span>
            <span class="mono">${state.connected ? t("ui.healthOk") : t("ui.healthOffline")}</span>
          </div>
      ...
      <aside class="nav ${state.settings.navCollapsed ? "nav--collapsed" : ""}">
        ${TAB_GROUPS.map((group) => {
          ...
          return html`
            <div class="nav-group ${isGroupCollapsed && !hasActiveTab ? "nav-group--collapsed" : ""}">
              ...
              >
                <span class="nav-label__text">${labelForTabGroup(group)}</span>
        ...
        <div class="nav-group nav-group--links">
          <div class="nav-label nav-label--static">
            <span class="nav-label__text">${t("ui.resources")}</span>
          </div>
          <div class="nav-group__items">
            <a
            ...
            >
              ...
              <span class="nav-item__text">${t("ui.docs")}</span>
            </a>
          </div>
        </div>
      </aside>
